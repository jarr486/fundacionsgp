<link rel="stylesheet" href="Scripts/menuVertical/css/style.css"> <!-- Resource style -->
<link rel="stylesheet" href="Scripts/menuVertical/css/reset.css"> <!-- CSS reset -->
<script src="Scripts/menuVertical/js/modernizr.js"></script> <!-- Modernizr -->

<script src="Scripts/menuVertical/js/jquery-2.1.4.js"></script>
<script src="Scripts/menuVertical/js/main.js"></script> <!-- Resource jQuery -->
