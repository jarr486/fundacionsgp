<?
 ...
 $seccion=query("SELECT * FROM noticias WHERE tipo='1' AND id='$id' ORDER BY id",1);
?>
<!DOCTYPE html>
<html>
<head>
...
?>
 <section id="cuerpoContenido">
     <br />
     <h1 style="line-height:20px;"><?=utf8_encode($seccion['titulo']);?></h1>
     <p><?=utf8_encode($seccion['texto_peq']);?></p>
